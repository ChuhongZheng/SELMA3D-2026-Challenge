...
#SBATCH --output=/midtier/paetzollab/scratch/ads4015/temp_selma_segmentation_preds_expert_sweep_31_v3/logs/build_submit_ft_cv_2_%j.out
#SBATCH --error=/midtier/paetzollab/scratch/ads4015/temp_selma_segmentation_preds_expert_sweep_31_v3/logs/build_submit_ft_cv_2_%j.err
#SBATCH --partition=minilab-cpu
#SBATCH --cpus-per-task=2
#SBATCH --mem=4G
#SBATCH --time=02:00:00

# finetune_and_inference_cv_build_and_submit2.sh - Script to build cross-validation folds and submit finetuning+inference array jobs using SLURM.
...
OUTDIR="/midtier/paetzollab/scratch/ads4015/temp_selma_segmentation_preds_expert_sweep_31_v3/cv_folds" # output dir for folds jsons and tasks file
REPEATS=3
SEED=100
CHANNELS="ALL"
TEST_SIZE=2
JOB_PREFIX="cv31"
ARRAY_SCRIPT="/home/ads4015/ssl_project/scripts/finetune_and_inference_cv_array_job2.sh"
